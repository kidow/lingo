...
export async function acquire() {
  const targets = [['礪',20,20,'Ja'],['遼',16,16,'MM'],['膜',15,15,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 礪 遼 膜 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:51,dictionaryStrokes:51,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
