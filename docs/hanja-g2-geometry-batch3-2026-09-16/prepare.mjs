...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 51, approvedCharacters: 3, approvedStrokes: 51,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch3-' + e.glyph.codePointAt(0).toString(16) + '-v1',
