...
import { validateG1Batch14DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch14.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch14.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-19', batch: { reviewed: 50, reviewedStrokes: compiled.review.reviewedStrokes,
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch14ApprovalsComplete: true, progress, nextBatch }, null, 2))
