...
export async function acquire() {
  const targets = [['蔑',15,15,'MM'],['茅',9,9,'MM'],['范',9,9,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 蔑 茅 范 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:33,dictionaryStrokes:33,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
