...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 33, approvedCharacters: 3, approvedStrokes: 33,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch4-' + e.glyph.codePointAt(0).toString(16) + '-v1',
