...
const runtime=hanjaStrokeData({glyph:'旴',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/65f4.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:8,strokeGroups:7,lastStrokeSegments:3,runtimeRegistered:1,privateMediaSaved:false}))
