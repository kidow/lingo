...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 594, approvedCharacters: 50, approvedStrokes: 594,
...
const verification = {
  ...
  scope: 'Grade 2 batch 4: 50 characters individually checked; 32 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch4-' + e.glyph.codePointAt(0).toString(16) + '-v1',
