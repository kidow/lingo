...
import { validateG2Batch4DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch4.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch4.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 594, applied: 50, appliedStrokes: 594,
    corrected: 32, locallyCorrectedPaths: 63, retainedPaths: 531, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch4ApprovalsComplete: true, progress, nextBatch }, null, 2))
