...
import { validateG1Batch4DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch4.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch4.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch4ApprovalsComplete: true, progress, nextBatch }, null, 2))
