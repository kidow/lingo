...
const pins = Object.fromEntries(['initial-observations.json', 'originals.json', 'observations.json', 'proposals.json', 'source-checks.json', 'corrections.json']
...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 674, approvedCharacters: 50, approvedStrokes: 674,
...
const verification = {
  ...
  scope: 'Grade 2 batch 3: 50 characters individually checked; 30 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch3-' + e.glyph.codePointAt(0).toString(16) + '-v1',
