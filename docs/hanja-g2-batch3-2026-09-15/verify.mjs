...
import { validateG2Batch3DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch3.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch3.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 674, applied: 50, appliedStrokes: 674,
    corrected: 30, locallyCorrectedPaths: 63, retainedPaths: 611, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch3ApprovalsComplete: true, progress, nextBatch }, null, 2))
