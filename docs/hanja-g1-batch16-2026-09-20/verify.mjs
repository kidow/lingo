...
import { validateG1Batch16DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch16.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch16.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch16ApprovalsComplete: true, progress, nextBatch }, null, 2))
