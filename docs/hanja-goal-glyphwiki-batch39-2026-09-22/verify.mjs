...
const expected = read('public/hanja-strokes/dictionary-reviewed-glyphwiki-batch39.json')
...
assert.deepEqual(hanjaStrokeData({ glyph: '蔓', strokes: 15 })?.paths, built[0].paths)
...
console.log(JSON.stringify({ passed: true, approvedGlyphs: 1, strokes: 15, sourceVersions: versions, privateGraphicsSaved: false }))
