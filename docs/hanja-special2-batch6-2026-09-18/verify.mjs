...
import { validateSpecial2Batch6DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch6.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch6.json'), compiled.runtime)
