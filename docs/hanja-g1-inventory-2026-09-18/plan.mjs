...
export function plan() {
  ...
  return {
    summary: {
      schemaVersion: 1, checkedAt: '2026-09-18', scope: '1급 배정 1,145자; metadata inventory, not stroke approval.',
    ...
    nextBatch: {
      schemaVersion: 1, title: '1급 첫 전체 획 검토 후보', basis: 'Exact dictionary title, consistent source metadata and at least one licensed candidate with matching catalog stroke count. These are intake conditions, not approval.',
