...
import { validateSpecialBatch12DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch12.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch12.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch12ApprovalsComplete: true, progress, nextBatch }, null, 2))
