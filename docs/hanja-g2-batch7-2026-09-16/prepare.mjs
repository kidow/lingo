...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 615, approvedCharacters: 50, approvedStrokes: 615,
...
const verification = {
  ...
  scope: 'Grade 2 batch 7: 50 characters individually checked; 44 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch7-' + e.glyph.codePointAt(0).toString(16) + '-v1',
