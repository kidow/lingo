...
import { validateG2Batch7DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch7.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch7.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 615, applied: 50, appliedStrokes: 615,
    corrected: 44, locallyCorrectedPaths: 125, retainedPaths: 490, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch7ApprovalsComplete: true, progress, nextBatch }, null, 2))
