...
const runtime=hanjaStrokeData({glyph:'玔',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/7394.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:7,strokeGroups:7,fifthStrokeSegments:2,runtimeRegistered:1,privateMediaSaved:false}))
