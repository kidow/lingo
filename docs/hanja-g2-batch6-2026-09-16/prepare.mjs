...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 574, approvedCharacters: 50, approvedStrokes: 574,
...
const verification = {
  ...
  scope: 'Grade 2 batch 6: 50 characters individually checked; 37 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch6-' + e.glyph.codePointAt(0).toString(16) + '-v1',
