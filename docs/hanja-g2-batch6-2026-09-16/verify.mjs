...
import { validateG2Batch6DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch6.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch6.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 574, applied: 50, appliedStrokes: 574,
    corrected: 37, locallyCorrectedPaths: 103, retainedPaths: 471, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch6ApprovalsComplete: true, progress, nextBatch }, null, 2))
