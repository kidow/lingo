...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 47, approvedCharacters: 3, approvedStrokes: 47,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch24-' + e.glyph.codePointAt(0).toString(16) + '-v1',
