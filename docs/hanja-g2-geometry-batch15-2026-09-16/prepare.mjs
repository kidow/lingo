...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 36, approvedCharacters: 3, approvedStrokes: 36,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch15-' + e.glyph.codePointAt(0).toString(16) + '-v1',
