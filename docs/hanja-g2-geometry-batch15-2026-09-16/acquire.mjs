...
export async function acquire() {
  const targets = [['湜',12,12,'ZhHans'],['珣',10,10,'ZhHans'],['瑢',14,14,'ZhHans']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 湜 珣 瑢 exact-character alternate-corpus candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:36,dictionaryStrokes:36,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
