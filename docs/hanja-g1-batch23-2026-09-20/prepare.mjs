...
if (observations.status !== 'complete' || observations.entries.length !== 3
  || accepted.length + held.length !== 3 || accepted.length !== 3
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g1-batch23-' + e.glyph.codePointAt(0).toString(16) + '-v1',
