...
import { validateG1Batch23DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch23.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch23.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch23ApprovalsComplete: true, progress, nextBatch }, null, 2))
