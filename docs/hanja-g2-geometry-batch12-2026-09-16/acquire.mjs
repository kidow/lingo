...
export async function acquire() {
  const targets = [['陜',10,10,'MM'],['邢',7,7,'MM'],['祜',10,10,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 陜 邢 祜 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:27,dictionaryStrokes:27,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
