...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 27, approvedCharacters: 3, approvedStrokes: 27,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch12-' + e.glyph.codePointAt(0).toString(16) + '-v1',
