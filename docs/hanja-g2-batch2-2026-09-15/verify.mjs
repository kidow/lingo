...
import { validateG2Batch2DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch2.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch2.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-15', batch: { reviewed: 50, reviewedStrokes: 658, applied: 50, appliedStrokes: 658,
    corrected: 17, locallyCorrectedPaths: 26, retainedPaths: 632, held: 0 },
