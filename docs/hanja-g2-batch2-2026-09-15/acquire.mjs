...
export async function acquire() {
  const batch = JSON.parse(read('../hanja-g2-batch1-followup-2026-09-15/next-batch.json'))
  ...
  return { schemaVersion: 1, date: '2026-09-15', purpose: 'Licensed original geometry for review; no approval.',
