...
const runtime=hanjaStrokeData({glyph:'艽',strokes:6})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/827d.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:7,strokeGroups:6,curvedStrokes:2,runtimeRegistered:1,privateMediaSaved:false}))
