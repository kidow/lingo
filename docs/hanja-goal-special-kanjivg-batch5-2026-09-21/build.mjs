...
console.log(JSON.stringify(entries.map(review => {
  ...
  if (review.rendering.sourceSha256 !== entry.candidate.sha256 || review.rendering.sourceStrokeWidth !== 3 || review.rendering.normalizedStrokeWidth !== 300 / 109) throw new Error("Unreviewed rendering width")
