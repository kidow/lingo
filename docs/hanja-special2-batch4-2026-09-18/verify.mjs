...
import { validateSpecial2Batch4DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch4.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch4.json'), compiled.runtime)
