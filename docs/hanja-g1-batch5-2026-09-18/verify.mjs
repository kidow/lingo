...
import { validateG1Batch5DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch5.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch5.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch5ApprovalsComplete: true, progress, nextBatch }, null, 2))
