...
import { validateSpecial2Batch15DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch15.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch15.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch15ApprovalsComplete: true, progress, nextBatch }, null, 2))
