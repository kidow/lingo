...
import { validateSpecial2Batch10DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch10.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch10.json'), compiled.runtime)
