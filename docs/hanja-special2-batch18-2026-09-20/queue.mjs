/** Read-only: the special grade II review queue recomputed against all five pinned candidate corpora,
...
const cat = read('content/hanja/characters/special-2.json').characters
const dic = read('docs/hanja-special2-inventory-2026-09-18/dictionary-inventory.json')
...
console.log(JSON.stringify({
  ...
  purpose: 'Special grade II review queue recomputed with all five pinned corpora. Intake conditions unchanged: exact dictionary title and metadata, dictionary stroke count equal to the catalog count, and a licensed candidate with the same count.',
