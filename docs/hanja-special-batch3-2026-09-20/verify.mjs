...
import { validateSpecialBatch3DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch3.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch3.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch3ApprovalsComplete: true, progress, nextBatch }, null, 2))
