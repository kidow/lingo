...
import { validateSpecialBatch4DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch4.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch4.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch4ApprovalsComplete: true, progress, nextBatch }, null, 2))
