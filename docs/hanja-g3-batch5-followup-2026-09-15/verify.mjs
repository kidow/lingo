...
assert.equal(review.records.reduce((n, e) => n + e.expectedStrokes, 0), 120)
...
assert.deepEqual(proposals['墻'].map(s => s.sourceStroke), [1,2,3,8,9,4,5,6,7,10,11,12,13,14,15,16])
assert.deepEqual(proposals['舟'].map(s => s.sourceStroke), [1,2,3,4,6,5])
...
console.log(JSON.stringify({
  result: 'pass', reviewedCharacters: 10, reviewedStrokes: 120,
  addedCharacters: 10, addedStrokes: 120, corrections: 10, heldCharacters: 0,
