...
export async function acquire() {
  const targets = [['鑽',27,27,'MM'],['蔡',15,15,'MM'],['葡',13,13,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 鑽 蔡 葡 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:55,dictionaryStrokes:55,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
