...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 55, approvedCharacters: 3, approvedStrokes: 55,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch11-' + e.glyph.codePointAt(0).toString(16) + '-v1',
