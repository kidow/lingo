...
import { validateG2Batch8DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch8.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch8.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 591, applied: 50, appliedStrokes: 591,
    corrected: 43, locallyCorrectedPaths: 136, retainedPaths: 455, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch8ApprovalsComplete: true, progress, nextBatch }, null, 2))
