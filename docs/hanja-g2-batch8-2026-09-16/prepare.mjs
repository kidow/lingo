...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 591, approvedCharacters: 50, approvedStrokes: 591,
...
const verification = {
  ...
  scope: 'Grade 2 batch 8: 50 characters individually checked; 43 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch8-' + e.glyph.codePointAt(0).toString(16) + '-v1',
