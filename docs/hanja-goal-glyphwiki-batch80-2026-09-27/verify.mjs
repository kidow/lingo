...
const runtime=hanjaStrokeData({glyph:'牣',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/7263.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:8,strokeGroups:7,curvedStrokes:6,runtimeRegistered:1,privateMediaSaved:false}))
