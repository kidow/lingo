...
권장했던 慨·遣·苟·旣·飢 **5자·59획**은 [다음 검토 기록](../hanja-g3-boundaries1-2026-09-15/README.md)에서 모두 적용했다. 위의 1,799자·3급 298자 집계는 이 문서의 최초 완료 시점 기록으로 유지한다.

후속 완료 시점에는 전체 **1,804/5,978자**, 3급 **303/317자** 적용이며, 3급에 **14자·162획**이 남았다. 다음 권장 범위는 **茫·暮·募·苗·迷·返 6자·65획**이다. 최신 범위와 남은 목록은 후속 기록을 따른다.
