...
import { validateG1Batch6DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch6.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch6.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch6ApprovalsComplete: true, progress, nextBatch }, null, 2))
