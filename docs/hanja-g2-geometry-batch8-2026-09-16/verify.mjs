...
import {HANJA_DICTIONARY_G2_GEOMETRY_BATCH8_STROKES} from '../../lib/hanja-stroke-dictionary-g2-geometry-batch8.ts'
import {buildG2GeometryBatch8DictionaryBundle,validateG2GeometryBatch8DictionaryBundle} from '../../scripts/hanja-stroke-dictionary-g2-geometry-batch8.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-geometry-batch8.json'),prepared.runtime)
assert.deepEqual(buildG2GeometryBatch8DictionaryBundle(),prepared.runtime)
validateG2GeometryBatch8DictionaryBundle()
assert.deepEqual(originals.entries.map(e=>[e.glyph,e.strokes,e.catalogStrokes,e.dictionaryStrokes]),[['瑛',12,13,13],['暎',12,13,13],['芮',7,8,8]])
assert.equal(typeof corrections.basis,'string')
assert.equal(corrections.edits.length,34)
...
const expectedContacts=[["瑛",1,3,true],["瑛",2,3,true],["瑛",3,4,true],["瑛",1,5,true],["瑛",4,11,true],["瑛",5,6,true],["瑛",5,7,false],["瑛",7,8,true],["瑛",6,9,false],["瑛",6,10,false],["瑛",8,10,false],["瑛",6,12,false],["瑛",8,12,false],["瑛",9,10,true],["瑛",9,11,true],["瑛",10,11,true],["瑛",10,12,true],["瑛",11,12,true],["瑛",11,13,true],["瑛",12,13,false],["暎",1,2,true],["暎",1,3,true],["暎",2,3,true],["暎",1,4,true],["暎",2,4,true],["暎",2,5,false],["暎",2,11,false],["暎",5,6,true],["暎",5,7,false],["暎",7,8,true],["暎",6,9,false],["暎",8,10,false],["暎",6,12,false],["暎",8,12,false],["暎",9,10,true],["暎",9,11,true],["暎",10,11,true],["暎",10,12,true],["暎",11,12,true],["暎",11,13,true],["暎",12,13,false],["芮",1,2,true],["芮",1,3,false],["芮",3,4,true],["芮",2,6,false],["芮",4,6,false],["芮",2,8,false],["芮",4,8,false],["芮",5,6,true],["芮",5,7,false],["芮",6,7,false],["芮",6,8,true],["芮",7,8,true],["芮",5,8,false]]
...
const expectedProgressions=[{"glyph":"瑛","stroke":1,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":2,"segments":[{"command":"L","x":"right","screenY":"same"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":3,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":4,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":5,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":6,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":7,"segments":[{"command":"L","x":"right","screenY":"same"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":8,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":9,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":10,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":11,"segments":[{"command":"L","x":"right","screenY":"same"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":12,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"瑛","stroke":13,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":1,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":2,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":3,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":4,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":5,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":6,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":7,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":8,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":9,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":10,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":11,"segments":[{"command":"L","x":"right","screenY":"same"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":12,"segments":[{"command":"L","x":"same","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"暎","stroke":13,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":1,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":2,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":3,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":4,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":5,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":6,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":7,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芮","stroke":8,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false}]
...
const previous=read('../hanja-g2-geometry-batch7-2026-09-16/progress.json')
...
assert.deepEqual(nextGlyphs,['莞','芸','蔚'])
...
const nextBatch={schemaVersion:1,title:'莞·芸·蔚 3자·'+nextStrokes+'획 경로 획수 차이 검토',characters:3,strokes:nextStrokes,
...
const progress={date:'2026-09-16',batch:{sourceAudited:3,reviewedStrokes:34,applied:3,appliedStrokes:34,held:0,authoredOrCorrectedPaths:34},
...
for(const entry of HANJA_DICTIONARY_G2_GEOMETRY_BATCH8_STROKES){
