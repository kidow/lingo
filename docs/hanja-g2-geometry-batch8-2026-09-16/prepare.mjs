...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 34, approvedCharacters: 3, approvedStrokes: 34,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch8-' + e.glyph.codePointAt(0).toString(16) + '-v1',
