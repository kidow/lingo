#!/usr/bin/env python3
"""Pinned 50-glyph comparison. Source videos and decoded frames stay in RAM."""
import base64
import hashlib
import html
    ...
    def do_GET(self):
        try:
            ...
            if self.path.startswith('/metadata'):
                ...
                title = f"{glyph} · {item['strokes']} strokes · {item['candidate']} · {r['durationSeconds']}s"
...
if __name__ == '__main__':
    ...
    print(f'G3 batch2 review: http://127.0.0.1:{server.server_port}', flush=True)
