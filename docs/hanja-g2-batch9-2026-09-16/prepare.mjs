...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 578, approvedCharacters: 50, approvedStrokes: 578,
...
const verification = {
  ...
  scope: 'Grade 2 batch 9: 50 characters individually checked; 41 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch9-' + e.glyph.codePointAt(0).toString(16) + '-v1',
