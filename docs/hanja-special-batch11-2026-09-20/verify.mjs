...
import { validateSpecialBatch11DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch11.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch11.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch11ApprovalsComplete: true, progress, nextBatch }, null, 2))
