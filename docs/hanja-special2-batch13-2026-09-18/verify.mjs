...
import { validateSpecial2Batch13DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch13.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch13.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch13ApprovalsComplete: true, progress, nextBatch }, null, 2))
