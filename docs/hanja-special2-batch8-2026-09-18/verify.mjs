...
import { validateSpecial2Batch8DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch8.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch8.json'), compiled.runtime)
