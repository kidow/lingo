...
if (observations.status !== 'complete' || accepted.length !== 44 || observations.entries.length !== 50)
...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 581, approvedCharacters: 44, approvedStrokes: 506,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch1-' + e.glyph.codePointAt(0).toString(16) + '-v1',
