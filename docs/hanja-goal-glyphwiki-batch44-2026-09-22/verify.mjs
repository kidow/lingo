...
const runtime=hanjaStrokeData({glyph:'苛',strokes:9})
assert(runtime);assert.equal(runtime.verificationSource,'ehanja-crosschecked')
assert.equal(proof.groups.length,10);assert.equal(sourceGroups.length,9)
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:10,strokeGroups:9,lastStrokePolygons:4,runtimeRegistered:1,privateMediaSaved:false}))
