...
const runtime=hanjaStrokeData({glyph:'芍',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/828d.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:8,strokeGroups:7,enclosureSegments:4,runtimeRegistered:1,privateMediaSaved:false}))
