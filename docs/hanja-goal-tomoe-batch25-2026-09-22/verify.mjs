...
assert.equal(actual.reduce((n,e) => n + e.strokes, 0), 32)
...
assert.deepEqual(next.remainingCountMatched, [])
assert.equal(next.newSourceLead.name, 'GlyphWiki / KAGE')
console.log(JSON.stringify({passed:true,publicSourceAndPointHashes:true,normalizedPathHashes:2,domesticVisualSteps:32,newRuntimeGlyphs:0,nextCountMatchedGlyphs:0}))
