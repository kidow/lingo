...
import { validateSpecial2Batch2DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch2.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch2.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch2ApprovalsComplete: true, progress, nextBatch }, null, 2))
