...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: strokes, approvedCharacters: 50, approvedStrokes: strokes,
...
const corrected = observations.entries.filter(e => e.initialDecision !== 'matched').length
const verification = {
  id: 'ehanja-crosschecked', title: 'e-hanja 필순·방향 교차검토', url: 'http://www.e-hanja.kr/',
  scope: `Special grade II batch 2: 50 characters individually checked; ${corrected} corrected forms rechecked. Not exam-body certification.`,
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-special2-batch2-' + e.glyph.codePointAt(0).toString(16) + '-v1',
