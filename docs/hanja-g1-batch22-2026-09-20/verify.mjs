...
import { validateG1Batch22DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch22.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch22.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-20', batch: { reviewed: 3, reviewedStrokes: compiled.review.reviewedStrokes,
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch22ApprovalsComplete: true, progress, nextBatch }, null, 2))
