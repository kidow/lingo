...
const review = {
  ...
  reviewedCharacters: 50, reviewedStrokes: 622, approvedCharacters: 50, approvedStrokes: 622,
...
const verification = {
  ...
  scope: 'Grade 2 batch 5: 50 characters individually checked; 33 corrected forms rechecked. Not exam-body certification.',
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch5-' + e.glyph.codePointAt(0).toString(16) + '-v1',
