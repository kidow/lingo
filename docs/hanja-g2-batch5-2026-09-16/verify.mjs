...
import { validateG2Batch5DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g2-batch5.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-batch5.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-16', batch: { reviewed: 50, reviewedStrokes: 622, applied: 50, appliedStrokes: 622,
    corrected: 33, locallyCorrectedPaths: 99, retainedPaths: 523, held: 0 },
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch5ApprovalsComplete: true, progress, nextBatch }, null, 2))
