...
import {HANJA_DICTIONARY_G2_GEOMETRY_BATCH5_STROKES} from '../../lib/hanja-stroke-dictionary-g2-geometry-batch5.ts'
import {buildG2GeometryBatch5DictionaryBundle,validateG2GeometryBatch5DictionaryBundle} from '../../scripts/hanja-stroke-dictionary-g2-geometry-batch5.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-geometry-batch5.json'),prepared.runtime)
assert.deepEqual(buildG2GeometryBatch5DictionaryBundle(),prepared.runtime)
validateG2GeometryBatch5DictionaryBundle()
assert.deepEqual(originals.entries.map(e=>[e.glyph,e.strokes,e.catalogStrokes,e.dictionaryStrokes]),[['縫',16,17,17],['蓬',14,15,15],['芬',7,8,8]])
...
const expectedContacts=[["縫",1,2,false],["縫",2,3,true],["縫",2,4,true],["縫",4,5,false],["縫",4,6,false],["縫",13,17,false],["縫",7,8,true],["縫",7,9,true],["蓬",6,11,false],["蓬",7,11,false],["蓬",11,15,false],["芬",5,7,true],["芬",7,8,true],["芬",4,6,false],["縫",3,16,false]]
...
const expectedProgressions=[{"glyph":"縫","stroke":1,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"up"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":2,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":4,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":5,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":14,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":15,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":16,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"縫","stroke":17,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"蓬","stroke":14,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蓬","stroke":15,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"芬","stroke":6,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芬","stroke":7,"segments":[{"command":"L","x":"right","screenY":"same"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"芬","stroke":8,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false}]
...
const previous=read('../hanja-g2-geometry-batch4-2026-09-16/progress.json')
...
assert.equal(queues.geometryCountReview.strokes,previous.remainingGrade2Queues.geometryCountReview.strokes-40)
...
assert.deepEqual(nextGlyphs,['蔘','薛','陝'])
...
const nextBatch={schemaVersion:1,title:'蔘·薛·陝 3자·'+nextStrokes+'획 경로 획수 차이 검토',characters:3,strokes:nextStrokes,
...
const progress={date:'2026-09-16',batch:{sourceAudited:3,reviewedStrokes:40,applied:3,appliedStrokes:40,held:0,authoredOrCorrectedPaths:27},
...
for(const entry of HANJA_DICTIONARY_G2_GEOMETRY_BATCH5_STROKES){
