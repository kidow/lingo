...
export async function acquire() {
  const targets = [['縫',17,17,'MM'],['蓬',15,15,'Ja'],['芬',8,8,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 縫 蓬 芬 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
