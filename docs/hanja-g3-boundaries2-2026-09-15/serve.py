#!/usr/bin/env python3
"""Pinned grade3 boundary batch2 comparison. Source videos and decoded frames stay in RAM."""
import base64
import hashlib
import html
...
if __name__ == '__main__':
    server = ThreadingHTTPServer(('127.0.0.1', 51738), Handler)
    print(f'G3 boundaries2: http://127.0.0.1:{server.server_port}', flush=True)
