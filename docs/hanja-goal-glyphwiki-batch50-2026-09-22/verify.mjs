...
const runtime=hanjaStrokeData({glyph:'萌',strokes:12})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/840c.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:14,strokeGroups:12,hookSegments:4,runtimeRegistered:1,privateMediaSaved:false}))
