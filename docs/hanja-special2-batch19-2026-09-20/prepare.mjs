...
if (observations.status !== 'complete' || observations.entries.length !== 6
  || accepted.length + held.length !== 6
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-special2-batch19-' + e.glyph.codePointAt(0).toString(16) + '-v1',
