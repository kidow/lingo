...
import { validateSpecial2Batch19DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch19.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch19.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-20', batch: { reviewed: 6, reviewedStrokes: compiled.review.reviewedStrokes,
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch19ApprovalsComplete: true, progress, nextBatch }, null, 2))
