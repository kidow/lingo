...
import {HANJA_DICTIONARY_G2_GEOMETRY_BATCH16_STROKES} from '../../lib/hanja-stroke-dictionary-g2-geometry-batch16.ts'
import {buildG2GeometryBatch16DictionaryBundle,validateG2GeometryBatch16DictionaryBundle} from '../../scripts/hanja-stroke-dictionary-g2-geometry-batch16.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-geometry-batch16.json'),prepared.runtime)
assert.deepEqual(buildG2GeometryBatch16DictionaryBundle(),prepared.runtime)
validateG2GeometryBatch16DictionaryBundle()
assert.deepEqual(originals.entries.map(e=>[e.glyph,e.strokes,e.catalogStrokes,e.dictionaryStrokes]),[['珽',10,11,11]])
assert.equal(typeof corrections.basis,'string')
assert.equal(corrections.edits.length,11)
...
const expectedContacts=[["珽",1,2,false],["珽",1,3,true],["珽",1,4,false],["珽",1,5,false],["珽",1,6,false],["珽",1,7,false],["珽",1,8,false],["珽",1,9,false],["珽",1,10,false],["珽",1,11,false],["珽",2,3,true],["珽",2,4,false],["珽",2,5,false],["珽",2,6,false],["珽",2,7,false],["珽",2,8,false],["珽",2,9,false],["珽",2,10,false],["珽",2,11,false],["珽",3,4,true],["珽",3,5,false],["珽",3,6,false],["珽",3,7,false],["珽",3,8,false],["珽",3,9,false],["珽",3,10,false],["珽",3,11,false],["珽",4,5,false],["珽",4,6,false],["珽",4,7,false],["珽",4,8,false],["珽",4,9,false],["珽",4,10,false],["珽",4,11,false],["珽",5,6,false],["珽",5,7,true],["珽",5,8,false],["珽",5,9,false],["珽",5,10,false],["珽",5,11,false],["珽",6,7,true],["珽",6,8,false],["珽",6,9,false],["珽",6,10,false],["珽",6,11,false],["珽",7,8,true],["珽",7,9,false],["珽",7,10,false],["珽",7,11,false],["珽",8,9,false],["珽",8,10,false],["珽",8,11,false],["珽",9,10,true],["珽",9,11,false],["珽",10,11,true]]
...
const expectedProgressions=[{"glyph":"珽","stroke":1,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":2,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":3,"segments":[{"command":"L","x":"same","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":4,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":5,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":6,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":7,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":8,"segments":[{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":9,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":10,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"珽","stroke":11,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false}]
...
const previous=read('../hanja-g2-geometry-batch15-2026-09-16/progress.json')
...
assert.deepEqual(nextGlyphs,['騏','乭','旼'])
...
const nextBatch={schemaVersion:1,title:'騏·乭·旼 3자·'+nextStrokes+'획 경로 구성 가능성 검토',characters:nextGlyphs.length,strokes:nextStrokes,
...
const progress={date:'2026-09-16',batch:{sourceAudited:1,reviewedStrokes:11,applied:1,appliedStrokes:11,held:0,authoredOrCorrectedPaths:11},
...
assert.equal(progress.overall.applied,previous.overall.applied+1)
assert.equal(progress.overall.appliedStrokes,previous.overall.appliedStrokes+11)
for(const entry of HANJA_DICTIONARY_G2_GEOMETRY_BATCH16_STROKES){
...
const proofFiles=['split-review.json','acquire.mjs','serve.py','prepare.mjs','verify.mjs','initial-observations.json','originals.json','source-checks.json','observations.json','corrections.json','proposals.json','candidate-paths.json','review.json']
...
console.log(JSON.stringify({verification:'passed',reconstructionAndPublicationValid:true,allElevenStagesObserved:true,catalogUnchanged:true,
