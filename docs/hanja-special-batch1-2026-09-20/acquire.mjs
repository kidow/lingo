...
export async function acquire() {
  const batch = JSON.parse(read('../hanja-special-inventory-2026-09-20/next-batch.json'))
  ...
  // The special grade draws on all five pinned corpora: 冂 has only a Ko candidate and 榦 only a Hant one.
