...
import { validateG1Batch20DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch20.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch20.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch20ApprovalsComplete: true, progress, nextBatch }, null, 2))
