...
import { validateG1Batch9DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch9.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch9.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch9ApprovalsComplete: true, progress, nextBatch }, null, 2))
