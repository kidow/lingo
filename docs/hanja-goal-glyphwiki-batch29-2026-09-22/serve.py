#!/usr/bin/env python3
"""Compare 芒 source strokes without saving dictionary graphics."""
import sys
...
r.ENTRIES = [{'glyph':'芒','id':'glyphwiki-u8292-k-corrected','dictionaryStrokes':7,
    'dictionary':meta['dictionary'],'viewBox':'0 0 100 100','strokeWidth':4,
    'strokes':[{'path':p} for p in approved['paths']]}]
r.base.renderer.ENTRIES['芒'] = {'strokes':7,'dictionary':meta['dictionary']}
...
if __name__ == '__main__':
    port = int(sys.argv[1]) if len(sys.argv)>1 else 51870
