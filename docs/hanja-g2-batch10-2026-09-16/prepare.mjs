...
if (observations.status !== 'complete' || accepted.length !== 7 || observations.entries.length !== 7)
...
const review = {
  ...
  reviewedCharacters: 7, reviewedStrokes: 108, approvedCharacters: 7, approvedStrokes: 108,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch10-' + e.glyph.codePointAt(0).toString(16) + '-v1',
