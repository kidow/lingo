...
export async function acquire() {
  ...
  const entries = []
  for (const [glyph, expected, dictionaryCount] of [['瓊',19,18]]) {
  ...
  return { schemaVersion: 1, date: '2026-09-16', purpose: 'Unapproved licensed candidate; nineteen-stroke variant boundaries require review.',
    sources: { MM: { ...pin, bytes: bytes.length } }, entries, characters: 1, strokes: 19, dictionaryStrokes: 18,
