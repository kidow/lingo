...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 40, approvedCharacters: 3, approvedStrokes: 40,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch22-' + e.glyph.codePointAt(0).toString(16) + '-v1',
