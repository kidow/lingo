...
export async function acquire() {
  const targets = [['鈗',12,12,'Components'],['鎰',18,18,'Components'],['曺',10,10,'Components']]
  ...
  const layouts = {
    '鈗': [{glyph:'金',targetBox:[7,12,31,81]},{glyph:'允',targetBox:[45,10,48,82]}],
    '鎰': [{glyph:'金',targetBox:[7,12,31,81]},{glyph:'益',targetBox:[44,10,49,82]}],
    '曺': [{glyph:'一',targetBox:[9,20,82,1]},{glyph:'由',targetBox:[26,7,50,48]},{glyph:'日',targetBox:[29,63,43,30]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch22-2026-09-17/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-17',purpose:'Unapproved 鈗 鎰 曺 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:40,dictionaryStrokes:40,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
