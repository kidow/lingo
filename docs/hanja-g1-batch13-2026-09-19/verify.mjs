...
import { validateG1Batch13DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch13.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch13.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch13ApprovalsComplete: true, progress, nextBatch }, null, 2))
