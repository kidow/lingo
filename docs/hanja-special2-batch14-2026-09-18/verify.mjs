...
import { validateSpecial2Batch14DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch14.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch14.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch14ApprovalsComplete: true, progress, nextBatch }, null, 2))
