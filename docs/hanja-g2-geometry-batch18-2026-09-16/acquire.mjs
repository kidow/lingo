...
export async function acquire() {
  const targets = [['磻',17,17,'Components'],['裵',14,14,'Components'],['倂',10,10,'Components']]
  ...
  const layouts = {
    '磻': [{glyph:'石',targetBox:[6,25,32,52]},{glyph:'番',targetBox:[43,10,51,80]}],
    '裵': [{glyph:'非',targetBox:[16,10,68,43]},{glyph:'衣',targetBox:[10,54,81,39]}],
    '倂': [{glyph:'亻',targetBox:[8,12,20,77]},{glyph:'午',targetBox:[35,12,23,77]},{glyph:'午',targetBox:[66,12,25,77]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch18-2026-09-16/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 磻 裵 倂 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
