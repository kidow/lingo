...
import { validateG1Batch15DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch15.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch15.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch15ApprovalsComplete: true, progress, nextBatch }, null, 2))
