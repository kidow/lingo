...
import { validateG1Batch3DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch3.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch3.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch3ApprovalsComplete: true, progress, nextBatch }, null, 2))
