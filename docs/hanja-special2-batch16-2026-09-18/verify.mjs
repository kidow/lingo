...
import { validateSpecial2Batch16DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch16.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch16.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch16ApprovalsComplete: true, progress, nextBatch }, null, 2))
