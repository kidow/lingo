...
import { validateSpecial2Batch12DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch12.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch12.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch12ApprovalsComplete: true, progress, nextBatch }, null, 2))
