#!/usr/bin/env python3
"""Compare 芙 source strokes without saving dictionary graphics."""
import sys
...
r.ENTRIES = [{'glyph':'芙','id':'glyphwiki-u8299-k-corrected','dictionaryStrokes':8,
    'dictionary':meta['dictionary'],'viewBox':'0 0 100 100','strokeWidth':4,
    'strokes':[{'path':p} for p in approved['paths']]}]
r.base.renderer.ENTRIES['芙'] = {'strokes':8,'dictionary':meta['dictionary']}
...
if __name__ == '__main__':
    port = int(sys.argv[1]) if len(sys.argv)>1 else 51865
