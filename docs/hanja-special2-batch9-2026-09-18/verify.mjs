...
import { validateSpecial2Batch9DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch9.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch9.json'), compiled.runtime)
