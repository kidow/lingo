...
import { validateSpecialBatch2DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch2.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch2.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch2ApprovalsComplete: true, progress, nextBatch }, null, 2))
