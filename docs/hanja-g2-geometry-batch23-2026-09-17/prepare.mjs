...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 44, approvedCharacters: 3, approvedStrokes: 44,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch23-' + e.glyph.codePointAt(0).toString(16) + '-v1',
