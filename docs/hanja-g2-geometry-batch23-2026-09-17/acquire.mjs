...
export async function acquire() {
  const targets = [['晙',11,11,'Components'],['埈',10,10,'Components'],['瓚',23,23,'Components']]
  ...
  const layouts = {
    '晙': [{glyph:'日',targetBox:[8,24,26,53]},{glyph:'厶',targetBox:[52,7,36,22]},{glyph:'八',targetBox:[43,33,50,19]},{glyph:'夂',targetBox:[43,53,51,41]}],
    '埈': [{glyph:'土',targetBox:[7,21,29,61]},{glyph:'厶',targetBox:[52,7,36,22]},{glyph:'八',targetBox:[43,33,50,19]},{glyph:'夂',targetBox:[43,53,51,41]}],
    '瓚': [{glyph:'王',targetBox:[7,17,24,66]},{glyph:'先',targetBox:[38,7,24,39]},{glyph:'先',targetBox:[70,7,24,39]},{glyph:'貝',targetBox:[42,54,49,40]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch23-2026-09-17/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-17',purpose:'Unapproved 晙 埈 瓚 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:44,dictionaryStrokes:44,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
