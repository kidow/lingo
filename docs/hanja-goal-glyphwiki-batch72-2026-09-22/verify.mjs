...
const runtime=hanjaStrokeData({glyph:'芃',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/8283.json',import.meta.url))
...
assert.deepEqual(trace[4][0].args.slice(2,4),trace[4][1].args.slice(0,2))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:8,strokeGroups:7,curvedStrokes:3,runtimeRegistered:1,privateMediaSaved:false}))
