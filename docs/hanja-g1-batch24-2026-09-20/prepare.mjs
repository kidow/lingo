...
if (observations.status !== 'complete' || observations.entries.length !== 16
  || accepted.length + held.length !== 16
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g1-batch24-' + e.glyph.codePointAt(0).toString(16) + '-v1',
