...
console.log(JSON.stringify(entries.map(review => {
  ...
  if (review.rendering.sourceSha256 !== entry.candidate.sha256 || review.rendering.normalizedStrokeWidth !== ({ "餔": 4.6 })[entry.glyph]) throw new Error("Unreviewed rendering width")
