#!/usr/bin/env python3
"""Pinned grade3 source identity follow-up comparison. Source videos and decoded frames stay in RAM."""
import base64
import hashlib
import html
...
if __name__ == '__main__':
    server = ThreadingHTTPServer(('127.0.0.1', 51739), Handler)
    print(f'G3 source identity: http://127.0.0.1:{server.server_port}', flush=True)
