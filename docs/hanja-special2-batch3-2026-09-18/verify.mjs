...
import { validateSpecial2Batch3DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch3.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch3.json'), compiled.runtime)
