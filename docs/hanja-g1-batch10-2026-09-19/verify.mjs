...
import { validateG1Batch10DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch10.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch10.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch10ApprovalsComplete: true, progress, nextBatch }, null, 2))
