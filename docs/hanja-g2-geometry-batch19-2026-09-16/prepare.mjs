...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 30, approvedCharacters: 3, approvedStrokes: 30,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch19-' + e.glyph.codePointAt(0).toString(16) + '-v1',
