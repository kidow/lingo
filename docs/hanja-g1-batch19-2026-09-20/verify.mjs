...
import { validateG1Batch19DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch19.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch19.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch19ApprovalsComplete: true, progress, nextBatch }, null, 2))
