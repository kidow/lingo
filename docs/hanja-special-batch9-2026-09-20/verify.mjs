...
import { validateSpecialBatch9DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch9.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch9.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch9ApprovalsComplete: true, progress, nextBatch }, null, 2))
