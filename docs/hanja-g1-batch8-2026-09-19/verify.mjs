...
import { validateG1Batch8DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch8.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch8.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch8ApprovalsComplete: true, progress, nextBatch }, null, 2))
