#!/usr/bin/env python3
"""Pinned grade3 authored pair comparison comparison. Source videos and decoded frames stay in RAM."""
import base64
import hashlib
import html
...
# Source-only loader: no foreign glyph or component is substituted.
...
if __name__ == '__main__':
    server = ThreadingHTTPServer(('127.0.0.1', 51740), Handler)
    print(f'G3 authored pair: http://127.0.0.1:{server.server_port}', flush=True)
