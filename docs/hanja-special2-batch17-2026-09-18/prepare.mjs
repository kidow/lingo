...
if (observations.status !== 'complete' || observations.entries.length !== 11
  || accepted.length + held.length !== 11 || accepted.length !== 11
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-special2-batch17-' + e.glyph.codePointAt(0).toString(16) + '-v1',
