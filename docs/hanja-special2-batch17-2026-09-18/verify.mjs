...
import { validateSpecial2Batch17DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch17.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch17.json'), compiled.runtime)
...
const progress = {
  date: '2026-09-18', batch: { reviewed: 11, reviewedStrokes: compiled.review.reviewedStrokes,
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch17ApprovalsComplete: true, progress, nextBatch }, null, 2))
