...
const verification = {
  ...
  scope: `Special grade II batch 1: 50 characters individually checked; ${corrected} corrected forms rechecked. Not exam-body certification.`,
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-special2-batch1-' + e.glyph.codePointAt(0).toString(16) + '-v1',
