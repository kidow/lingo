...
export async function acquire() {
  const targets = [['葛',13,13,'MM'],['儆',15,15,'MM'],['菓',12,12,'Ja']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 葛 儆 菓 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
