...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 42, approvedCharacters: 3, approvedStrokes: 42,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch6-' + e.glyph.codePointAt(0).toString(16) + '-v1',
