...
export async function acquire() {
  const targets = [['蔘',15,15,'Ja'],['薛',17,17,'MM'],['陝',10,10,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 蔘 薛 陝 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:42,dictionaryStrokes:42,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
