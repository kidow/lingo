...
import {HANJA_DICTIONARY_G2_GEOMETRY_BATCH6_STROKES} from '../../lib/hanja-stroke-dictionary-g2-geometry-batch6.ts'
import {buildG2GeometryBatch6DictionaryBundle,validateG2GeometryBatch6DictionaryBundle} from '../../scripts/hanja-stroke-dictionary-g2-geometry-batch6.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g2-geometry-batch6.json'),prepared.runtime)
assert.deepEqual(buildG2GeometryBatch6DictionaryBundle(),prepared.runtime)
validateG2GeometryBatch6DictionaryBundle()
assert.deepEqual(originals.entries.map(e=>[e.glyph,e.strokes,e.catalogStrokes,e.dictionaryStrokes]),[['蔘',14,15,15],['薛',16,17,17],['陝',9,10,10]])
assert.equal(corrections.automaticRadicalApproval,false)
assert.equal(corrections.edits.length,42)
...
const expectedContacts=[["蔘",2,5,false],["蔘",4,6,false],["蔘",5,6,true],["蔘",5,7,false],["蔘",5,9,false],["蔘",7,8,true],["蔘",9,10,true],["蔘",8,11,true],["蔘",9,12,true],["蔘",11,12,true],["蔘",11,13,false],["蔘",12,13,false],["蔘",13,14,false],["蔘",14,15,false],["薛",2,5,false],["薛",5,6,false],["薛",5,7,true],["薛",6,7,true],["薛",6,8,true],["薛",7,8,true],["薛",6,9,true],["薛",6,10,true],["薛",9,10,true],["薛",4,11,false],["薛",11,12,true],["薛",12,13,false],["薛",12,14,true],["薛",13,15,true],["薛",14,15,true],["薛",15,17,true],["薛",16,17,true],["陝",1,2,true],["陝",1,3,true],["陝",2,3,true],["陝",2,5,true],["陝",5,6,true],["陝",7,8,true],["陝",4,5,false],["陝",4,6,false],["陝",4,7,false],["陝",4,8,false],["陝",4,9,true],["陝",5,9,false],["陝",6,9,false],["陝",7,9,false],["陝",8,9,false],["陝",9,10,true]]
...
const expectedProgressions=[{"glyph":"蔘","stroke":5,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":6,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":7,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":8,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":9,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":10,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":11,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":12,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":13,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":14,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"蔘","stroke":15,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"薛","stroke":5,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"薛","stroke":11,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"薛","stroke":13,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"薛","stroke":14,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"薛","stroke":17,"segments":[{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":1,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":2,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"up"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":5,"segments":[{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":6,"segments":[{"command":"L","x":"right","screenY":"up"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":7,"segments":[{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":8,"segments":[{"command":"L","x":"right","screenY":"same"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":9,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"left","screenY":"down"},{"command":"L","x":"left","screenY":"down"}],"sourceArtworkSaved":false},{"glyph":"陝","stroke":10,"segments":[{"command":"L","x":"right","screenY":"down"},{"command":"L","x":"right","screenY":"down"}],"sourceArtworkSaved":false}]
...
const previous=read('../hanja-g2-geometry-batch5-2026-09-16/progress.json')
...
assert.equal(queues.geometryCountReview.strokes,previous.remainingGrade2Queues.geometryCountReview.strokes-42)
...
assert.deepEqual(nextGlyphs,['荀','艾','惹'])
...
const nextBatch={schemaVersion:1,title:'荀·艾·惹 3자·'+nextStrokes+'획 경로 획수 차이 검토',characters:3,strokes:nextStrokes,
...
const progress={date:'2026-09-16',batch:{sourceAudited:3,reviewedStrokes:42,applied:3,appliedStrokes:42,held:0,authoredOrCorrectedPaths:42},
...
assert.equal(progress.overall.appliedStrokes,previous.overall.appliedStrokes+42)
for(const entry of HANJA_DICTIONARY_G2_GEOMETRY_BATCH6_STROKES){
...
console.log(JSON.stringify({verification:'passed',reconstructionAndPublicationValid:true,allFortyTwoStagesObserved:true,catalogUnchanged:true,
