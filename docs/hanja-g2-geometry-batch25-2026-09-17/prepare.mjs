...
const candidate = {
  date: '2026-09-17', coordinateSystem: '100 x 100, y downward; licensed normalized centerlines with reviewed corrections',
...
const review = {
  date: '2026-09-17', verificationSource: 'ehanja-crosschecked',
  ...
  reviewedCharacters: 3, reviewedStrokes: 46, approvedCharacters: 3, approvedStrokes: 46,
...
const characters = accepted.map(e => {
  ...
  return {
    glyph: e.glyph, verifiedAt: '2026-09-17', geometrySource: geometry[original.corpus].sha256,
    geometryCorrection: 'dictionary-g2-geometry-batch25-' + e.glyph.codePointAt(0).toString(16) + '-v1',
