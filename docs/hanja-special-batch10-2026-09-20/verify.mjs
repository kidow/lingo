...
import { validateSpecialBatch10DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch10.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch10.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch10ApprovalsComplete: true, progress, nextBatch }, null, 2))
