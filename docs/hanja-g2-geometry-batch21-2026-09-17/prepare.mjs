...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 43, approvedCharacters: 3, approvedStrokes: 43,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch21-' + e.glyph.codePointAt(0).toString(16) + '-v1',
