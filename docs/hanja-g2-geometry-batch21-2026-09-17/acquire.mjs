...
export async function acquire() {
  const targets = [['姸',9,9,'Components'],['燁',15,15,'Components'],['鏞',19,19,'Components']]
  ...
  const layouts = {
    '姸': [{glyph:'女',targetBox:[7,17,33,72]},{glyph:'干',targetBox:[42,12,22,79]},{glyph:'干',targetBox:[70,12,22,79]}],
    '燁': [{glyph:'火',targetBox:[7,17,28,73]},{glyph:'華',targetBox:[40,8,51,84]}],
    '鏞': [{glyph:'金',targetBox:[7,12,31,81]},{glyph:'庸',targetBox:[44,7,49,87]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch21-2026-09-17/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-17',purpose:'Unapproved 姸 燁 鏞 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:43,dictionaryStrokes:43,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
