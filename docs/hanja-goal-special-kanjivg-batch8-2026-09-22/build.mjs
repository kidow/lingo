...
console.log(JSON.stringify(entries.map(review => {
  ...
  if (review.rendering.sourceSha256 !== entry.candidate.sha256 || review.rendering.normalizedStrokeWidth !== ({ "隰": 300 / 109, "阨": 5 })[entry.glyph]) throw new Error("Unreviewed rendering width")
