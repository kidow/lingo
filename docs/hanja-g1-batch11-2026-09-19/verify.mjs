...
import { validateG1Batch11DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch11.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch11.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch11ApprovalsComplete: true, progress, nextBatch }, null, 2))
