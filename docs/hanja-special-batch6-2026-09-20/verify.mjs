...
import { validateSpecialBatch6DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch6.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch6.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch6ApprovalsComplete: true, progress, nextBatch }, null, 2))
