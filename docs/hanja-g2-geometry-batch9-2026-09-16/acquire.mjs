...
export async function acquire() {
  const targets = [['莞',11,11,'MM'],['芸',8,8,'MM'],['蔚',15,15,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 莞 芸 蔚 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
