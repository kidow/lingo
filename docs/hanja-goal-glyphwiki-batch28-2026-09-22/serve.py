#!/usr/bin/env python3
"""Compare 茸 source strokes without saving dictionary graphics."""
import sys
...
r.ENTRIES = [{'glyph':'茸','id':'glyphwiki-u8338-k-corrected','dictionaryStrokes':10,
    'dictionary':meta['dictionary'],'viewBox':'0 0 100 100','strokeWidth':4,
    'strokes':[{'path':p} for p in approved['paths']]}]
r.base.renderer.ENTRIES['茸'] = {'strokes':10,'dictionary':meta['dictionary']}
...
if __name__ == '__main__':
    port = int(sys.argv[1]) if len(sys.argv)>1 else 51867
