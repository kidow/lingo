...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 29, approvedCharacters: 3, approvedStrokes: 29,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch7-' + e.glyph.codePointAt(0).toString(16) + '-v1',
