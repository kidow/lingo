...
export async function acquire() {
  const targets = [['荀',10,10,'MM'],['艾',6,6,'MM'],['惹',13,13,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 荀 艾 惹 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:29,dictionaryStrokes:29,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
