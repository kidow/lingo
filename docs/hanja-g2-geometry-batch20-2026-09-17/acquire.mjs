...
export async function acquire() {
  const targets = [['晳',12,12,'Components'],['璿',18,18,'Components'],['卨',11,11,'Components']]
  ...
  const layouts = {
    '晳': [{glyph:'析',targetBox:[9,8,82,44]},{glyph:'日',targetBox:[29,60,43,31]}],
    '璿': [{glyph:'王',targetBox:[8,17,23,68]},{glyph:'睿',targetBox:[39,9,54,84]}],
    '卨': [{glyph:'卜',targetBox:[46,8,29,22]},{glyph:'咼',targetBox:[17,38,69,54]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch20-2026-09-17/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-17',purpose:'Unapproved 晳 璿 卨 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
