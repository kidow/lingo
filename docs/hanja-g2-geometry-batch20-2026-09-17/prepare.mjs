...
const review = {
  ...
  reviewedCharacters: 3, reviewedStrokes: 41, approvedCharacters: 3, approvedStrokes: 41,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch20-' + e.glyph.codePointAt(0).toString(16) + '-v1',
