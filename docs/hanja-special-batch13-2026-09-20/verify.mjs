...
import { validateSpecialBatch13DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch13.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch13.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch13ApprovalsComplete: true, progress, nextBatch }, null, 2))
