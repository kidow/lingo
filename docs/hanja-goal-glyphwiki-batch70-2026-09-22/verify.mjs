...
const runtime=hanjaStrokeData({glyph:'杕',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/6755.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:7,strokeGroups:7,curvedStrokes:4,runtimeRegistered:1,privateMediaSaved:false}))
