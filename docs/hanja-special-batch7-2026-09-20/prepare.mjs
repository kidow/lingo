...
const verification = {
  ...
  scope: `Special grade batch 7: 50 characters individually checked, ${accepted.length} approved and ${held.length} held; ${corrected} corrected forms rechecked. Not exam-body certification.`,
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-special-batch7-' + e.glyph.codePointAt(0).toString(16) + '-v1',
