...
import { validateSpecialBatch7DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch7.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch7.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch7ApprovalsComplete: true, progress, nextBatch }, null, 2))
