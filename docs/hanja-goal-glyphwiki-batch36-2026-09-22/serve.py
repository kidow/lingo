#!/usr/bin/env python3
"""Compare 萃 source strokes without saving dictionary graphics."""
import sys
...
r.ENTRIES = [{'glyph':'萃','id':'glyphwiki-u8403-k-width2','dictionaryStrokes':12,
    'dictionary':meta['dictionary'],'viewBox':'0 0 100 100','strokeWidth':2,
    'strokes':[{'path':p} for p in approved['paths']]}]
r.base.renderer.ENTRIES['萃'] = {'strokes':12,'dictionary':meta['dictionary']}
...
if __name__ == '__main__':
    port = int(sys.argv[1]) if len(sys.argv)>1 else 51886
