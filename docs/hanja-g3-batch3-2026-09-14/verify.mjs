...
assert.equal(queue.entries.reduce((sum, e) => sum + e.strokes, 0), 571)
...
assert.equal(corrections.recipes.length, 4)
...
const result = {
  result: 'pass', reviewedCharacters: 50, reviewedStrokes: 571,
