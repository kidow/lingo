...
export async function acquire() {
  ...
  const entries = []
  for (const [glyph, expected, dictionaryCount] of [['藍',18,17],['蘆',20,19]]) {
    ...
    entries.push({ glyph, strokes: expected, catalogStrokes: expected, dictionaryStrokes: dictionaryCount, corpus: 'MM',
  ...
  return { schemaVersion: 1, date: '2026-09-16', purpose: 'Unapproved licensed candidates; four-stroke grass boundaries require review.',
    sources: { MM: { ...pin, bytes: bytes.length } }, entries, characters: 2, strokes: 38, dictionaryStrokes: 36,
