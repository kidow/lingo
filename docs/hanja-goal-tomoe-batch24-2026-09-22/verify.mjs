...
assert.equal(actual.reduce((n,e) => n + e.strokes, 0), 47)
...
assert.equal(next.remainingCountMatched.length, 2)
assert.equal(new Set(next.remainingCountMatched.map(e=>e.glyph)).size,2)
...
console.log(JSON.stringify({passed:true,publicSourceAndPointHashes:true,normalizedPathHashes:3,domesticVisualSteps:47,newRuntimeGlyphs:0,nextCountMatchedGlyphs:2}))
