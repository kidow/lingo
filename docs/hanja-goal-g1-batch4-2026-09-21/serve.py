"""Pinned licensed candidates against private domestic graphics in RAM."""
import sys
...
if (HERE / "alternatives.json").exists():
    entries += json.loads((HERE / "alternatives.json").read_text())["entries"]
review.ENTRIES = []
