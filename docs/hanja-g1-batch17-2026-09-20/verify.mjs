...
import { validateG1Batch17DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch17.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch17.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch17ApprovalsComplete: true, progress, nextBatch }, null, 2))
