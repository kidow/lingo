...
export async function acquire() {
  const targets = [['苑',9,9,'MM'],['芝',8,8,'MM'],['遮',15,15,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 苑 芝 遮 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
