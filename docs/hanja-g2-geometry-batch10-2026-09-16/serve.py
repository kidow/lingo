...
spec=importlib.util.spec_from_file_location('gb10_renderer',HERE.parent/'hanja-g2-batch10-2026-09-16/serve.py')
...
if __name__=='__main__':
    print('G2 geometry batch 10 review http://127.0.0.1:51746',flush=True)
