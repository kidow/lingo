...
import { validateSpecial2Batch7DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch7.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch7.json'), compiled.runtime)
