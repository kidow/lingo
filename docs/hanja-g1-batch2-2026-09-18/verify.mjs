...
import { validateG1Batch2DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch2.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch2.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch2ApprovalsComplete: true, progress, nextBatch }, null, 2))
