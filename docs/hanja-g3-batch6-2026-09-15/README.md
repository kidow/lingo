...
두 차례 후속 보정으로 **20자·229획을 추가 적용**했다. 이 50자 묶음은 현재 **35자·326획 적용, 15자·221획 보류**다.
[첫 후속 검토](../hanja-g3-batch6-followup-2026-09-15/README.md)와 [최신 검토](../hanja-g3-batch6-followup2-2026-09-15/README.md)에 보정 내역과 다음 권장 작업이 있다.
아래 본문과 표는 최초 검토 당시의 기록이며, 濯·貪·貝·旱의 일부 접합 판단과 奚의 방향 판단은 후속 확대 대조에서 보완·정정했다.
