...
네 차례 후속 보정으로 **35자·448획을 추가 적용**했다. 이 50자 묶음은 현재 **50자·545획 적용 완료, 보류 0자**다. 한국어문회의 후속 설명을 대조해 幣 15→14획, 蔽 16→15획으로 보정했으며 최초 547획과 원문 값은 보존했다.
[첫 후속 검토](../hanja-g3-batch6-followup-2026-09-15/README.md), [두 번째 검토](../hanja-g3-batch6-followup2-2026-09-15/README.md), [세 번째 검토](../hanja-g3-batch6-followup3-2026-09-15/README.md), [최신 경계·획수 검토](../hanja-g3-batch6-boundaries-2026-09-15/README.md)에 보정 내역과 다음 권장 작업이 있다.
아래 본문과 표는 최초 검토 당시의 기록이다. 일부 접합·방향 설명은 후속 확대 대조에서 정정했으며 최신 관찰 기록이 이를 대체한다.
