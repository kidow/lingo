...
후속 보정으로 **10자·128획을 추가 적용**했다. 이 50자 묶음은 현재 25자 적용·25자 보류다.
[후속 검토](../hanja-g3-batch6-followup-2026-09-15/README.md)에 보정 내역과 최신 권장 작업이 있다.
아래 본문과 표는 최초 검토 당시의 기록이며, 濯·貪의 일부 간격 판단은 후속 확대 대조에서 정정했다.
