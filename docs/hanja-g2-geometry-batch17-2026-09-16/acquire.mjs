...
export async function acquire() {
  const targets = [['騏',18,18,'Components'],['乭',6,6,'Components'],['旼',8,8,'Components']]
  ...
  const layouts = {
    '騏': [{glyph:'馬',targetBox:[8,12,37,77]},{glyph:'其',targetBox:[54,12,38,76]}],
    '乭': [{glyph:'石',targetBox:[14,10,73,44]},{glyph:'乙',targetBox:[26,63,60,28]}],
    '旼': [{glyph:'日',targetBox:[8,22,26,60]},{glyph:'文',targetBox:[44,11,48,79]}],
  }
  ...
  sources.Components = {url:'docs/hanja-g2-geometry-batch17-2026-09-16/originals.json#entries',
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 騏 乭 旼 alternate-corpus and component-based candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:3,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:32,dictionaryStrokes:32,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
