...
import { validateG1Batch1DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch1.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch1.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch1ApprovalsComplete: true, progress, nextBatch }, null, 2))
