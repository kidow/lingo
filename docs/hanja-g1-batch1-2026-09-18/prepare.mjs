...
const verification = {
  ...
  scope: `Grade 1 batch 1: 50 characters individually checked, ${accepted.length} approved and ${held.length} held; ${corrected} corrected forms rechecked. Not exam-body certification.`,
}
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g1-batch1-' + e.glyph.codePointAt(0).toString(16) + '-v1',
