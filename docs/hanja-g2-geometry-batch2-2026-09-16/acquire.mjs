...
export async function acquire() {
  const targets = [['董',13,13,'MM'],['藤',19,19,'MM'],['鄧',15,15,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 董 藤 鄧 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
