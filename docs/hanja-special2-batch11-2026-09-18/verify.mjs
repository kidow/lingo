...
import { validateSpecial2Batch11DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch11.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch11.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, batch11ApprovalsComplete: true, progress, nextBatch }, null, 2))
