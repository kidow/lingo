...
import { validateSpecial2Batch5DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special2-batch5.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special2-batch5.json'), compiled.runtime)
