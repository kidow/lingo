...
import { validateSpecialBatch8DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-special-batch8.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-special-batch8.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, specialBatch8ApprovalsComplete: true, progress, nextBatch }, null, 2))
