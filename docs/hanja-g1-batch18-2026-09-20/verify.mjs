...
import { validateG1Batch18DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch18.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch18.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch18ApprovalsComplete: true, progress, nextBatch }, null, 2))
