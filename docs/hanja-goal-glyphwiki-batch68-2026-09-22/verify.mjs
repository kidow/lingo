...
const runtime=hanjaStrokeData({glyph:'芑',strokes:7})
...
const editable=readFileSync(new URL('../../public/hanja-strokes/glyphwiki/8291.json',import.meta.url))
...
console.log(JSON.stringify({passed:true,sourceVersions,engineChecked,rawGroups:8,strokeGroups:7,lastStrokeSegments:4,runtimeRegistered:1,privateMediaSaved:false}))
