...
export async function acquire() {
  const batch = JSON.parse(read('../hanja-g1-batch11-2026-09-19/next-batch.json'))
  ...
  return { schemaVersion: 1, date: '2026-09-19', purpose: 'Licensed original geometry for review; no approval.',
