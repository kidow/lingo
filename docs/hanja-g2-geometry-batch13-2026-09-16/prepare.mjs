...
const review = {
  ...
  reviewedCharacters: 2, reviewedStrokes: 27, approvedCharacters: 2, approvedStrokes: 27,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-geometry-batch13-' + e.glyph.codePointAt(0).toString(16) + '-v1',
