...
export async function acquire() {
  const targets = [['薰',18,18,'MM'],['姬',9,9,'MM']]
  ...
  return {schemaVersion:1,date:'2026-09-16',purpose:'Unapproved 薰 姬 licensed candidates and refreshed whole-glyph dictionary sources; review every boundary and direction before registration.',
    sources,availability,entries,characters:2,strokes:entries.reduce((n,e)=>n+e.strokes,0),catalogStrokes:27,dictionaryStrokes:27,proprietaryAssetsSaved:0,runtimeApprovalsAdded:0}
}
