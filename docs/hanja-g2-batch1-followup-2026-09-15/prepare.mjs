...
if (observations.status !== 'complete' || accepted.length !== 6 || observations.entries.length !== 6)
...
const review = {
  ...
  reviewedCharacters: 6, reviewedStrokes: 75, approvedCharacters: 6, approvedStrokes: 75,
...
const characters = accepted.map(e => {
  ...
  return {
    ...
    geometryCorrection: 'dictionary-g2-batch1-followup-' + e.glyph.codePointAt(0).toString(16) + '-v1',
