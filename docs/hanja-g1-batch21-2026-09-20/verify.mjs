...
import { validateG1Batch21DictionaryBundle } from '../../scripts/hanja-stroke-dictionary-g1-batch21.ts'
...
assert.deepEqual(read('../../public/hanja-strokes/dictionary-reviewed-g1-batch21.json'), compiled.runtime)
...
console.log(JSON.stringify({ verification: 'passed', compilerMatchesArtifacts: true, proofPinsValid: true,
  uniqueRuntimeGlyphs: true, g1Batch21ApprovalsComplete: true, progress, nextBatch }, null, 2))
