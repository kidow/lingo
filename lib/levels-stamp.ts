...
export const LEVELS_STAMP: Readonly<Record<string, string>> = {
  ...
  'body.json': 'f96fe0a39c60',
  'city.json': 'a07fd11c318d',
  'clothes.json': '94179b8bc211',
  'everyday.json': '5857fb30593d',
  'family.json': '29d284f402c8',
  'food.json': 'bbdc73edbd01',
  'home.json': '1c89b5ed2485',
  ...
  'quality.json': '9e5a84c6d4d2',
  'scene.json': '21de2730b70a',
  'school.json': '1d2090862edc',
  'sport.json': '3030dde0d56a',
  'time.json': '2a8d04f632a0',
  'transport.json': '3924f9a2e7aa',
