...
訣 (11 strokes) and 紋 (10 strokes), modified for Lingo on 2026-09-13.

## Geometry copyright and modifications

訣 and eight strokes of 紋 derive from Make Me a Hanzi `graphics.txt`, commit
...
Filled outlines are omitted. Original order is retained for 訣.
...
animations for 訣 stroke 11 and 紋 strokes 4–5 only. It does not claim an exact
whole-glyph match, handwriting grading, or examination-body certification.
