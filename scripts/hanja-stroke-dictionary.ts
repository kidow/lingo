...
import { special2Batch19DictionaryGeometry, validateSpecial2Batch19DictionaryReview, validateSpecial2Batch19DictionaryBundle } from './hanja-stroke-dictionary-special2-batch19.ts'
...
import { g1Batch17DictionaryGeometry, validateG1Batch17DictionaryReview, validateG1Batch17DictionaryBundle } from './hanja-stroke-dictionary-g1-batch17.ts'
import { g1Batch18DictionaryGeometry, validateG1Batch18DictionaryReview, validateG1Batch18DictionaryBundle } from './hanja-stroke-dictionary-g1-batch18.ts'
import { g1Batch19DictionaryGeometry, validateG1Batch19DictionaryReview, validateG1Batch19DictionaryBundle } from './hanja-stroke-dictionary-g1-batch19.ts'
import { g1Batch20DictionaryGeometry, validateG1Batch20DictionaryReview, validateG1Batch20DictionaryBundle } from './hanja-stroke-dictionary-g1-batch20.ts'
import { g1Batch21DictionaryGeometry, validateG1Batch21DictionaryReview, validateG1Batch21DictionaryBundle } from './hanja-stroke-dictionary-g1-batch21.ts'
import { g1Batch22DictionaryGeometry, validateG1Batch22DictionaryReview, validateG1Batch22DictionaryBundle } from './hanja-stroke-dictionary-g1-batch22.ts'
import { g1Batch23DictionaryGeometry, validateG1Batch23DictionaryReview, validateG1Batch23DictionaryBundle } from './hanja-stroke-dictionary-g1-batch23.ts'
import { g1Batch24DictionaryGeometry, validateG1Batch24DictionaryReview, validateG1Batch24DictionaryBundle } from './hanja-stroke-dictionary-g1-batch24.ts'
import { specialBatch1DictionaryGeometry, validateSpecialBatch1DictionaryReview, validateSpecialBatch1DictionaryBundle } from './hanja-stroke-dictionary-special-batch1.ts'
import { specialBatch2DictionaryGeometry, validateSpecialBatch2DictionaryReview, validateSpecialBatch2DictionaryBundle } from './hanja-stroke-dictionary-special-batch2.ts'
import { specialBatch3DictionaryGeometry, validateSpecialBatch3DictionaryReview, validateSpecialBatch3DictionaryBundle } from './hanja-stroke-dictionary-special-batch3.ts'
import { specialBatch4DictionaryGeometry, validateSpecialBatch4DictionaryReview, validateSpecialBatch4DictionaryBundle } from './hanja-stroke-dictionary-special-batch4.ts'
import { specialBatch5DictionaryGeometry, validateSpecialBatch5DictionaryReview, validateSpecialBatch5DictionaryBundle } from './hanja-stroke-dictionary-special-batch5.ts'
import { specialBatch6DictionaryGeometry, validateSpecialBatch6DictionaryReview, validateSpecialBatch6DictionaryBundle } from './hanja-stroke-dictionary-special-batch6.ts'
import { specialBatch7DictionaryGeometry, validateSpecialBatch7DictionaryReview, validateSpecialBatch7DictionaryBundle } from './hanja-stroke-dictionary-special-batch7.ts'
import { specialBatch8DictionaryGeometry, validateSpecialBatch8DictionaryReview, validateSpecialBatch8DictionaryBundle } from './hanja-stroke-dictionary-special-batch8.ts'
import { specialBatch9DictionaryGeometry, validateSpecialBatch9DictionaryReview, validateSpecialBatch9DictionaryBundle } from './hanja-stroke-dictionary-special-batch9.ts'
import { specialBatch10DictionaryGeometry, validateSpecialBatch10DictionaryReview, validateSpecialBatch10DictionaryBundle } from './hanja-stroke-dictionary-special-batch10.ts'
import { specialBatch11DictionaryGeometry, validateSpecialBatch11DictionaryReview, validateSpecialBatch11DictionaryBundle } from './hanja-stroke-dictionary-special-batch11.ts'
import { specialBatch12DictionaryGeometry, validateSpecialBatch12DictionaryReview, validateSpecialBatch12DictionaryBundle } from './hanja-stroke-dictionary-special-batch12.ts'
import { specialBatch13DictionaryGeometry, validateSpecialBatch13DictionaryReview, validateSpecialBatch13DictionaryBundle } from './hanja-stroke-dictionary-special-batch13.ts'
import { specialBatch14DictionaryGeometry, validateSpecialBatch14DictionaryReview, validateSpecialBatch14DictionaryBundle } from './hanja-stroke-dictionary-special-batch14.ts'
...
import { special2Batch19DictionaryReference } from '../lib/hanja-stroke-dictionary-special2-batch19.ts'
...
import { g1Batch17DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch17.ts'
import { g1Batch18DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch18.ts'
import { g1Batch19DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch19.ts'
import { g1Batch20DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch20.ts'
import { g1Batch21DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch21.ts'
import { g1Batch22DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch22.ts'
import { g1Batch23DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch23.ts'
import { g1Batch24DictionaryReference } from '../lib/hanja-stroke-dictionary-g1-batch24.ts'
import { specialBatch1DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch1.ts'
import { specialBatch2DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch2.ts'
import { specialBatch3DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch3.ts'
import { specialBatch4DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch4.ts'
import { specialBatch5DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch5.ts'
import { specialBatch6DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch6.ts'
import { specialBatch7DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch7.ts'
import { specialBatch8DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch8.ts'
import { specialBatch9DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch9.ts'
import { specialBatch10DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch10.ts'
import { specialBatch11DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch11.ts'
import { specialBatch12DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch12.ts'
import { specialBatch13DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch13.ts'
import { specialBatch14DictionaryReference } from '../lib/hanja-stroke-dictionary-special-batch14.ts'
import {
...
export function dictionaryGeometry(glyph: string, medians: Medians) {
  ...
  if (special2Batch19DictionaryReference(glyph)) return special2Batch19DictionaryGeometry(glyph, medians)
  ...
  if (g1Batch17DictionaryReference(glyph)) return g1Batch17DictionaryGeometry(glyph, medians)
  if (g1Batch18DictionaryReference(glyph)) return g1Batch18DictionaryGeometry(glyph, medians)
  if (g1Batch19DictionaryReference(glyph)) return g1Batch19DictionaryGeometry(glyph, medians)
  if (g1Batch20DictionaryReference(glyph)) return g1Batch20DictionaryGeometry(glyph, medians)
  if (g1Batch21DictionaryReference(glyph)) return g1Batch21DictionaryGeometry(glyph, medians)
  if (g1Batch22DictionaryReference(glyph)) return g1Batch22DictionaryGeometry(glyph, medians)
  if (g1Batch23DictionaryReference(glyph)) return g1Batch23DictionaryGeometry(glyph, medians)
  if (g1Batch24DictionaryReference(glyph)) return g1Batch24DictionaryGeometry(glyph, medians)
  if (specialBatch1DictionaryReference(glyph)) return specialBatch1DictionaryGeometry(glyph, medians)
  if (specialBatch2DictionaryReference(glyph)) return specialBatch2DictionaryGeometry(glyph, medians)
  if (specialBatch3DictionaryReference(glyph)) return specialBatch3DictionaryGeometry(glyph, medians)
  if (specialBatch4DictionaryReference(glyph)) return specialBatch4DictionaryGeometry(glyph, medians)
  if (specialBatch5DictionaryReference(glyph)) return specialBatch5DictionaryGeometry(glyph, medians)
  if (specialBatch6DictionaryReference(glyph)) return specialBatch6DictionaryGeometry(glyph, medians)
  if (specialBatch7DictionaryReference(glyph)) return specialBatch7DictionaryGeometry(glyph, medians)
  if (specialBatch8DictionaryReference(glyph)) return specialBatch8DictionaryGeometry(glyph, medians)
  if (specialBatch9DictionaryReference(glyph)) return specialBatch9DictionaryGeometry(glyph, medians)
  if (specialBatch10DictionaryReference(glyph)) return specialBatch10DictionaryGeometry(glyph, medians)
  if (specialBatch11DictionaryReference(glyph)) return specialBatch11DictionaryGeometry(glyph, medians)
  if (specialBatch12DictionaryReference(glyph)) return specialBatch12DictionaryGeometry(glyph, medians)
  if (specialBatch13DictionaryReference(glyph)) return specialBatch13DictionaryGeometry(glyph, medians)
  if (specialBatch14DictionaryReference(glyph)) return specialBatch14DictionaryGeometry(glyph, medians)
...
export function validateDictionaryReview(review: HanjaDictionaryStrokeData, expectedStrokes: number) {
  ...
  if (special2Batch19DictionaryReference(review.glyph)) return validateSpecial2Batch19DictionaryReview(review, expectedStrokes)
  ...
  if (g1Batch17DictionaryReference(review.glyph)) return validateG1Batch17DictionaryReview(review, expectedStrokes)
  if (g1Batch18DictionaryReference(review.glyph)) return validateG1Batch18DictionaryReview(review, expectedStrokes)
  if (g1Batch19DictionaryReference(review.glyph)) return validateG1Batch19DictionaryReview(review, expectedStrokes)
  if (g1Batch20DictionaryReference(review.glyph)) return validateG1Batch20DictionaryReview(review, expectedStrokes)
  if (g1Batch21DictionaryReference(review.glyph)) return validateG1Batch21DictionaryReview(review, expectedStrokes)
  if (g1Batch22DictionaryReference(review.glyph)) return validateG1Batch22DictionaryReview(review, expectedStrokes)
  if (g1Batch23DictionaryReference(review.glyph)) return validateG1Batch23DictionaryReview(review, expectedStrokes)
  if (g1Batch24DictionaryReference(review.glyph)) return validateG1Batch24DictionaryReview(review, expectedStrokes)
  if (specialBatch1DictionaryReference(review.glyph)) return validateSpecialBatch1DictionaryReview(review, expectedStrokes)
  if (specialBatch2DictionaryReference(review.glyph)) return validateSpecialBatch2DictionaryReview(review, expectedStrokes)
  if (specialBatch3DictionaryReference(review.glyph)) return validateSpecialBatch3DictionaryReview(review, expectedStrokes)
  if (specialBatch4DictionaryReference(review.glyph)) return validateSpecialBatch4DictionaryReview(review, expectedStrokes)
  if (specialBatch5DictionaryReference(review.glyph)) return validateSpecialBatch5DictionaryReview(review, expectedStrokes)
  if (specialBatch6DictionaryReference(review.glyph)) return validateSpecialBatch6DictionaryReview(review, expectedStrokes)
  if (specialBatch7DictionaryReference(review.glyph)) return validateSpecialBatch7DictionaryReview(review, expectedStrokes)
  if (specialBatch8DictionaryReference(review.glyph)) return validateSpecialBatch8DictionaryReview(review, expectedStrokes)
  if (specialBatch9DictionaryReference(review.glyph)) return validateSpecialBatch9DictionaryReview(review, expectedStrokes)
  if (specialBatch10DictionaryReference(review.glyph)) return validateSpecialBatch10DictionaryReview(review, expectedStrokes)
  if (specialBatch11DictionaryReference(review.glyph)) return validateSpecialBatch11DictionaryReview(review, expectedStrokes)
  if (specialBatch12DictionaryReference(review.glyph)) return validateSpecialBatch12DictionaryReview(review, expectedStrokes)
  if (specialBatch13DictionaryReference(review.glyph)) return validateSpecialBatch13DictionaryReview(review, expectedStrokes)
  if (specialBatch14DictionaryReference(review.glyph)) return validateSpecialBatch14DictionaryReview(review, expectedStrokes)
...
export function validateDictionaryBundle(entries: readonly HanjaDictionaryStrokeData[] = HANJA_DICTIONARY_STROKES) {
  ...
  validateG1Batch21DictionaryBundle()
