...
const RU_ENDING = ['изироваться', 'ироваться', 'изировать', 'ировать', 'оваться', 'иваться', 'ываться', 'аться', 'яться', 'иться', 'еться', 'ться', 'овать', 'ивать', 'ывать', 'ать', 'ять', 'ить', 'еть', 'ыть', 'ся', 'ого', 'ому', 'ый', 'ий', 'ой', 'ая', 'яя', 'ое', 'ее', 'ые', 'ие', 'а', 'о', 'у', 'ы', 'и', 'е', 'я', 'ь']
